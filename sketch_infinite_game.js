...
splashscreen = loadImage("assets/picture.PNG")
...
if(lvl1bg.x<=0){
  ...
  // if(keyDown("UP_ARROW") &&  mario.y>=height/10){
  //   // mario.y -=5
  //   mario.velocityY=-5
  // }
...
// log the mario.y and platform y
// find the difference

    // // mario.y -=5
    // if (mario.isTouching(plat2) && mario.y<= plat2.y-150){
    //   mario.velocityY=-5
    // }
    // if (mario.isTouching(plat3) && mario.y<= plat3.y-150){
    //   mario.velocityY=-5
    // }
    // if (mario.isTouching(plat4) && mario.y<= plat4.y-150){
    //   mario.velocityY=-5
    // }
    // mario.velocityY =-5
console.log(mario.y)  
